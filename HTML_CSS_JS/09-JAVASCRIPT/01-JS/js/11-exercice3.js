...
Après avoir demandé à votre utilisateur son EMAIL et MOT DE PASSE, et après avoir vérifié ses informations, vous lui souhaiterez la bienvenue avec son nom et prénom (document.write);

En ca d'échec, vous afficherez une ALERT pour l'informer de l'erreur.
...
var BaseDeDonnees = [
    ...
    {'prenom' : 'Teva', 'nom' : 'NATCHITZ' , 'email' : 'teva@hl-media.fr' , 'mdp' : 'teva'},
    {'prenom' : 'Charles', 'nom' : 'CHARLY' , 'email' : 'charly@hl-media.fr' , 'mdp' : 'charly'},
    {'prenom' : 'Nabila', 'nom' : 'NABILAA' , 'email' : 'nabila@hl-media.fr' , 'mdp' : 'nabila'},
]
