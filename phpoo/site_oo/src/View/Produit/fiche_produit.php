...
$contenu .= '<div classe="col-md-8">
                  <img src="'.$produit['photo'].'" alt="" class="img-responsive">
              </div>';

$contenu .= '<div classe="col-md-4">
                <h3>Description</h3>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                  <h4 class="modal-title">Le produit à été ajouté</h4>
                              </div>
...
<script>
    $(function(){
        $("#myModal").modal("show"); // appelle la boite modale bootstrap
    });
</script>
